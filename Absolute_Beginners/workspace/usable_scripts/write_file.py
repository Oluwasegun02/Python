...
# how to run this arg example
# 1 python usable_scripts/write_file.py output/subdir/numbers.txput/subdir/numbers.txt't -d  
# 2 python usable_scripts/write_file.py output/number.txt -s 1 -f 200
# 3 python usable_scripts/write_file.py output/number.txt 